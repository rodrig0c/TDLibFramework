...
let package = Package(
   ...
   products: [
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TDLibFramework",
            url: "https://github.com/Swiftgram/TDLibFramework/releases/download/1.8.53-bdec6af5/TDLibFramework.zip",
            checksum: "3e217d310a72a7f1532320f845e97fba5867cc69222289863beecbe377734dcb"
        ),
        .testTarget(
